...
export function matchesShortcut(event: KeyboardEvent, shortcut: string): boolean {
  ...
  return (
    event.ctrlKey === expectedModifiers.has('ctrl') &&
...
function findCommentStart(line: string): { index: number; markerLength: number } | null {
  let quote: "'" | '"' | null = null;
  let escaped = false;
...
export function extractAssistantDirective(source: string): AssistantDirective | null {
